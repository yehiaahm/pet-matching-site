...
export { LandingPage, AuthPage, ProfileVerificationPage, Dashboard, AIMatchingPage, FeaturesShowcasePage, NotificationsCenter, AdminSupportDashboard };
  ...
  return { loadTime, isLoaded, recordLoadTime, resetMetrics };
};
...
export const preloadComponent = (component: React.LazyExoticComponent<any, any>) => {
...
export {
  ...
  LazyDashboard,
  LazyAuthPage,
  LazyProfileVerificationPage,
  LazyAIMatchingPage,
  LazyFeaturesShowcasePage,
  LazyNotificationsCenter,
  LazyAdminSupportDashboard,
  useLazyLoading,
  usePageLoadMetrics,
  preloadComponent,
